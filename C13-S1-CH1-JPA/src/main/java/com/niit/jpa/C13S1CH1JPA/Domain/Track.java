package com.niit.jpa.C13S1CH1JPA.Domain;
...
public class Track {
    ...
    public String toString() {
        return "Track{" + "trackId=" + trackId + ", trackName='" + trackName + '\'' + ", trackComments='" + trackComments + '\'' + ", trackRating='" + trackRating + '\'' + ", trackArtist='" + trackArtist + '\'' + '}';
    }
}
